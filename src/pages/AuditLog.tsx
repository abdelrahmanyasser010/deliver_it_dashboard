...
function actionLabel(action: string) {
  const labels: Record<string, string> = {
    'shipment/assignDriver': 'تعيين مندوب', 'shipment/transition': 'تغيير حالة شحنة', 'shipment/addAttempt': 'تسجيل محاولة توصيل', 'shipment/import': 'استيراد شحنات', 'pickup/approve': 'اعتماد استلام', 'pickup/review': 'مراجعة استلام', 'batch/assign': 'تعيين مجموعة توزيع', 'driverUpdate/approve': 'اعتماد تحديث مندوب', 'driverUpdate/reject': 'رفض تحديث مندوب', 'barcode/create': 'إنشاء دفعة باركود', 'barcode/close': 'إغلاق دفعة باركود', 'exception/resolve': 'حل استثناء', 'driver/upsert': 'حفظ مندوب', 'driver/delete': 'حذف مندوب', 'merchant/upsert': 'حفظ تاجر', 'settlement/create': 'إنشاء تسوية', 'settlement/approve': 'اعتماد تسوية', 'settlement/pay': 'دفع تسوية', 'finance/reconcileShipment': 'مطابقة مالية', 'ledger/postAll': 'ترحيل قيود', 'period/close': 'إغلاق فترة مالية',
  };
